...
<html>
 ...
 <body>
  ...
  <div class="container">
   ...
   @if($validationErrors = Session::get('validationErrors'))
    <div class="alert alert-danger">
     Upload Validation Error<br><br>
     <ul>
   ...
   @if($message = Session::get('dbError'))
      ...
      <tr>
       ...
       <td>
        ...
        <select name="type" id="type">
          ...
          <option value="developerProjectRelationships">Developer-ProjectcRelationships</option>
        </select>
      </td>
